...
public class GetInactivePartnersUseCaseImpl implements GetAllPartnerUseCase {
    private final PartnerRepositoryGateway repositoryGateway;

    public GetInactivePartnersUseCaseImpl(PartnerRepositoryGateway repositoryGateway) {
    ...
    public List<Partner> execute() {
        ...
        return repositoryGateway.findByActive(false);
    }
}
